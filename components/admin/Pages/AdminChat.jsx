...
const AdminChat = () => {
    ...
    return (
        <div className="flex h-[calc(100vh-120px)] bg-[var(--bg)] rounded-xl border border-slate-200 shadow-sm overflow-hidden relative">
            {/* Sidebar List */}
            <div className={`
                w-full lg:w-80 border-r border-slate-200 flex flex-col bg-[var(--bg)] z-10
            ...
            `}>
                {activeChat && currentChat ? (
                    <>
                        {/* Chat Header */}
                        <div className="h-16 bg-[var(--bg)] border-b border-slate-200 px-4 sm:px-6 flex items-center justify-between">
                                    ...
                                    return (
                                        <div key={index} className={`flex ${isAdmin ? 'justify-end' : 'justify-start'}`}>
                                            <div className={`max-w-[85%] sm:max-w-[70%] rounded-2xl px-4 py-3 text-sm shadow-sm ${isAdmin
                                                ...
                                                : 'bg-[var(--bg)] text-slate-700 rounded-tl-none border border-slate-200'
                                                }`}>
                                                <p>{msg.message}</p>
                        ...
                        {/* Input Area */}
                        <div className="p-4 bg-[var(--bg)] border-t border-slate-200">
