    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <button className="flex items-center gap-2 px-4 py-2 bg-[var(--bg)] border border-slate-200 rounded-lg text-slate-600 hover:bg-slate-50 text-sm font-medium">
                    <Calendar size={16} />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {loading ? (
                    ...
                    <div key={i} className="bg-[var(--bg)] p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                {/* Recent Orders Table */}
                <div className="lg:col-span-2 bg-[var(--bg)] rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                ...
                <div className="space-y-6">
                    <div className="bg-[var(--bg)] p-6 rounded-xl border border-slate-200 shadow-sm">
