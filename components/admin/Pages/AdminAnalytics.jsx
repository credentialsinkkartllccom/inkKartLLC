        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            ...
            {loading && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[...Array(4)].map((_, i) => (
                        <div key={i} className="bg-[var(--bg)] p-6 rounded-xl border border-slate-200 shadow-sm animate-pulse">
            ...
            {!loading && analytics && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={i} className="bg-[var(--bg)] p-6 rounded-xl border border-slate-200 shadow-sm flex items-start justify-between">
                            <div>
            ...
            {!loading && analytics?.recentOrders && analytics.recentOrders.length > 0 && (
                <div className="bg-[var(--bg)] rounded-xl border border-slate-200 shadow-sm overflow-hidden">
