...
const AdminCategories = () => {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500 pb-20">
            ...
            {/* Simple Form */}
            {isFormOpen && (
                <div className="bg-[var(--bg)] rounded-2xl border border-slate-200 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                        ...
                        filteredCategories?.map((cat) => (
                            <div key={cat._id} className="group px-8 py-6 flex items-center justify-between hover:bg-blue-50/30 transition-all">
                                <div className="flex items-center gap-6">
                                    <div className="w-12 h-12 bg-[var(--bg)] rounded-2xl shadow-sm border border-slate-100 flex items-center justify-center text-blue-600 group-hover:scale-110 transition-transform">
                                        <Layers size={24} />
                                    </div>
                                ...
                                <div className="flex items-center gap-2">
                                    <button 
                                        ...
                                        className="p-3 bg-[var(--bg)] hover:bg-blue-600 text-slate-400 hover:text-white rounded-xl shadow-sm border border-slate-100 transition-all"
                                    >
                                        <Edit size={20} />
                                    </button>
                                    <button 
                                        onClick={() => handleDelete(cat._id)} 
                                        className="p-3 bg-[var(--bg)] hover:bg-red-600 text-slate-400 hover:text-white rounded-xl shadow-sm border border-slate-100 transition-all"
                                    >
                                        <Trash2 size={20} />
                                    </button>
                                </div>
